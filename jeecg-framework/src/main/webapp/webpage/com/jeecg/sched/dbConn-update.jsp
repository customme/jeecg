...
<body>
	<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="dbConnController.do?doUpdate">
		...
		<table>
			<tr>
				...
				<td class="value">
					<input id="name" name="name" type="text" value='${dbConnPage.name}' style="width:250px" />
