...
<body>
	<t:formvalid formid="formobj" dialog="true" layout="table" action="taskTypeController.do?doAdd">
		...
		<table>
			<tr>
				...
				<td class="value">
					<input id="code" name="code" type="text" validType="t_task_type,code,id" datatype="s4-64" ignore="checked" />
			...
			<tr>
				...
				<td class="value">
					<input id="taskExecutor" name="taskExecutor" type="text" validType="t_task_type,task_executor,id" datatype="*8-255" ignore="checked" />
			...
			<tr>
				...
				<td class="value">
					<textarea id="description" name="description" datatype="*0-500" ignore="ignore"></textarea>
