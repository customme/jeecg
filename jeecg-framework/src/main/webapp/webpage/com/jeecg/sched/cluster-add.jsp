...
<body>
	<t:formvalid formid="formobj" dialog="true" layout="table" action="clusterController.do?doAdd">
		...
		<table>
			<tr>
				...
				<td class="value">
					<input id="name" name="name" type="text" datatype="*2-64" ignore="checked" style="width:200px" />
