...
<body>
	<t:formvalid formid="formobj" dialog="true" layout="table" action="taskController.do?doCopy">
		...
		<table>
			<tr>
				...
				<td class="value">
					<input id="name" name="name" type="text" datatype="*2-64" ignore="checked" value='${taskPage.name} - 副本' />
			...
			<tr>
				<td align="right">
					<label class="Validform_label">深度复制: </label>
				</td>
				<td class="value">
					<label for="copyExt">扩展属性</label>
					<input type="checkbox" id="copyExt" name="copyExt" value="1" checked="checked" />
					<label for="copyLink">依赖关系</label>
					<input type="checkbox" id="copyLink" value="1" name="copyLink" />
				</td>
			</tr>
		</table>
	</t:formvalid>
