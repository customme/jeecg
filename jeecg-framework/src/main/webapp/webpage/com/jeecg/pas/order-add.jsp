...
<body style="overflow-x:hidden;">
	<t:formvalid formid="formobj" dialog="true" layout="table" tiptype="1" action="orderController.do?doAdd">
		...
		<table class="formtable">
			...
			<tr>
				...
				<td class="value">
					<t:dictSelect field="deliverType" type="list" typeGroupCode="deliver_type" title="运送方式"></t:dictSelect>
				</td>
				<td align="right">
					<label class="Validform_label">运单号:</label>
				</td>
				<td class="value">
					<input id="expressNo" name="expressNo" type="text" />
				</td>
			</tr>
			<tr>
				<td colspan="4" style="padding:4px 0px 4px 0px">
			...
			<tr>
				...
				<td class="value">
					<input id="freight" name="freight" type="text" datatype="/^(-?\d+)(\.\d+)?$/" ignore="ignore" />
					<span class="Validform_checktip"></span>
			...
			<tr>
				...
				<td class="value">
					<input id="payment" type="text" readonly="readonly" />
				</td>
				<td align="right">
			...
			<tr>
				...
				<td class="value">
					<input id="paid" name="paid" type="text" datatype="/^(-?\d+)(\.\d+)?$/" ignore="ignore" />
					<span class="Validform_checktip"></span>
				...
				<td class="value">
					<t:dictSelect field="payMode" type="list" typeGroupCode="pay_mode" title="支付方式"></t:dictSelect>
				</td>
			</tr>
			<tr>
				<td align="right">
				...
				<td class="value">
					<t:dictSelect field="orderStatus" type="list" typeGroupCode="order_stat" defaultVal="0" extendJson="{ignore:'checked'}" title="订单状态"></t:dictSelect>
				</td>
				<td align="right">
		...
		<div style="width:auto; height:200px;">
			...
			<t:tabs id="orderItemTab" iframe="false" tabPosition="top" fit="false">
				<t:tab href="orderController.do?orderItemList&cartIds=${cartIds}" icon="icon-search" title="订单明细" id="orderItem"></t:tab>
			</t:tabs>
		</div>
	</t:formvalid>
</body>
