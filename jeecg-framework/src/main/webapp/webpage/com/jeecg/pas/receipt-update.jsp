...
<body>
	<t:formvalid formid="formobj" dialog="true" layout="table" action="receiptController.do?doUpdate">
		...
		<table class="formtable">
			...
			<tr>
				...
				<td class="value">
					<input id="totalAmount" name="totalAmount" type="text" datatype="/^(-?\d+)(\.\d+)?$/" ignore="checked" value='${receiptPage.totalAmount}' />
					<span class="Validform_checktip"></span>
			...
			<tr>
				...
				<td class="value">
					<input id="discountAmount" name="discountAmount" type="text" datatype="/^(-?\d+)(\.\d+)?$/" ignore="ignore" value='${receiptPage.discountAmount}' />
					<span class="Validform_checktip"></span>
			...
			<tr>
				...
				<td class="value">
					<t:dictSelect id="currency" field="currency" type="list" typeGroupCode="currency"
						defaultVal="${receiptPage.currency}" extendJson="{ignore:'checked'}" title="币种"></t:dictSelect>
					<span class="Validform_checktip"></span>
			...
			<tr>
				...
				<td class="value">
					<t:dictSelect id="payMode" field="payMode" type="list" typeGroupCode="pay_mode"
						defaultVal="${receiptPage.payMode}" extendJson="{ignore:'checked'}" title="支付方式"></t:dictSelect>
					<span class="Validform_checktip"></span>
			...
			<tr>
				...
				<td class="value">
					<input id="buyTime" name="buyTime" type="text" class="Wdate" onClick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" datatype="*"
						ignore="checked" value='<fmt:formatDate value='${receiptPage.buyTime}' type="date" pattern="yyyy-MM-dd HH:mm:ss"/>' />
					<span class="Validform_checktip"></span>
			...
			<tr>
				...
				<td class="value">
					<input id="actualAmount" name="actualAmount" type="text" datatype="/^(-?\d+)(\.\d+)?$/" ignore="ignore" value='${receiptPage.actualAmount}' />
					<span class="Validform_checktip"></span>
			...
			<tr>
				...
				<td class="value">
					<textarea id="remark" name="remark">${receiptPage.remark}</textarea>
				</td>
			</tr>
		</table>
	</t:formvalid>
