...
public class ServerServiceImpl extends CommonServiceImpl implements ServerServiceI {
	...
	private void doDelBus(ServerEntity t) throws Exception{
 	...
 	private Map<String,Object> populationMap(ServerEntity t){
		...
		map.put("os", t.getOs());
		map.put("task_maximum", t.getTaskMaximum());
		map.put("beat_time", t.getBeatTime());
	 ...
	 */
 	public String replaceVal(String sql,ServerEntity t){
 		...
 		sql  = sql.replace("#{task_maximum}",String.valueOf(t.getTaskMaximum()));
 		sql  = sql.replace("#{beat_time}",String.valueOf(t.getBeatTime()));
 		...
 		if(StringUtil.isNotEmpty(cgJavaValue)){
			...
			try {
				...
				if(obj instanceof CgformEnhanceJavaInter){
					...
					javaInter.execute("t_server",data);
				}
			} catch (Exception e) {
				e.printStackTrace();
