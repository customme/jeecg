...
@Service("receiptItemService")
@Transactional
public class ReceiptItemServiceImpl extends CommonServiceImpl implements ReceiptItemServiceI {
	 ...
	 * @return
	 */
	private void doAddBus(ReceiptItemEntity t) throws Exception{
		//-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
	 ...
	 * @return
	 */
	private void doUpdateBus(ReceiptItemEntity t) throws Exception{
		//-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
	 ...
	 * @return
	 */
	private void doDelBus(ReceiptItemEntity t) throws Exception{
	    //-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
 	...
 	private Map<String,Object> populationMap(ReceiptItemEntity t){
	 ...
	 * @return
	 */
 	public String replaceVal(String sql,ReceiptItemEntity t){
 		...
 		if(StringUtil.isNotEmpty(cgJavaValue)){
			...
			try {
				...
				if(obj instanceof CgformEnhanceJavaInter){
					...
					javaInter.execute("ps_receipt_item",data);
				}
			} catch (Exception e) {
				e.printStackTrace();
