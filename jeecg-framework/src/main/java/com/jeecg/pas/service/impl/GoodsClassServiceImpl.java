...
@Transactional
public class GoodsClassServiceImpl extends CommonServiceImpl implements GoodsClassServiceI {
	 ...
	 * @return
	 */
	private void doAddBus(GoodsClassEntity t) throws Exception{
		//-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
	 ...
	 * @return
	 */
	private void doUpdateBus(GoodsClassEntity t) throws Exception{
		//-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
	 ...
	 * @return
	 */
	private void doDelBus(GoodsClassEntity t) throws Exception{
	    //-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
 	...
 	private Map<String,Object> populationMap(GoodsClassEntity t){
	 ...
	 * @return
	 */
 	public String replaceVal(String sql,GoodsClassEntity t){
 		...
 		if(StringUtil.isNotEmpty(cgJavaValue)){
			...
			try {
				...
				if(obj instanceof CgformEnhanceJavaInter){
					...
					javaInter.execute("ps_goods_class",data);
				}
			} catch (Exception e) {
				e.printStackTrace();
