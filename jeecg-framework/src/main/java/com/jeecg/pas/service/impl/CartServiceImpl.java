...
public class CartServiceImpl extends CommonServiceImpl implements CartServiceI {
	 ...
	 * @return
	 */
	private void doAddBus(CartEntity t) throws Exception{
		//-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
	 ...
	 * @return
	 */
	private void doUpdateBus(CartEntity t) throws Exception{
		//-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
	 ...
	 * @return
	 */
	private void doDelBus(CartEntity t) throws Exception{
	    //-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
 	...
 	private Map<String,Object> populationMap(CartEntity t){
		...
		map.put("buy_status", t.getBuyStatus());
	 ...
	 * @return
	 */
 	public String replaceVal(String sql,CartEntity t){
 		...
 		sql  = sql.replace("#{buy_status}",String.valueOf(t.getBuyStatus()));
